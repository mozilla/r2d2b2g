...
B2G_URL_BASE = https://ftp.mozilla.org/pub/mozilla.org/b2g/nightly/2014-01-07-00-40-01-mozilla-aurora/
...
ifeq (win32, $(B2G_PLATFORM))
  ...
  B2G_URL ?= $(B2G_URL_BASE)b2g-28.0a2.multi.win32.zip
  B2G_BIN_DIR = b2g
else
ifeq (mac64, $(B2G_PLATFORM))
  B2G_URL ?= $(B2G_URL_BASE)b2g-28.0a2.multi.mac64.dmg
  DOWNLOAD_CMD = /usr/bin/curl -O
  B2G_BIN_DIR = B2G.app/Contents/MacOS
else
ifeq (linux64, $(B2G_PLATFORM))
  B2G_URL ?= $(B2G_URL_BASE)b2g-28.0a2.multi.linux-x86_64.tar.bz2
  B2G_BIN_DIR = b2g
else
ifeq (linux, $(B2G_PLATFORM))
  B2G_URL ?= $(B2G_URL_BASE)b2g-28.0a2.multi.linux-i686.tar.bz2
  B2G_BIN_DIR = b2g
endif
endif
endif
