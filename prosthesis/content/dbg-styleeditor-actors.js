// https://hg.mozilla.org/releases/mozilla-aurora/annotate/ea2b0db82289/toolkit/devtools/styleeditor/dbg-styleeditor-actors.js
...
StyleEditorActor.prototype = {
  ...
  _addStyleSheets: function(styleSheets)
  {
    ...
    let forms = sheets.map((function (sheet) {
...
StyleSheetActor.prototype = {
  ...
  {
    try {
      NetUtil.asyncFetch(href, (function (stream, status) {
