...
cl.exe /c /GS /analyze- /W3 /Zc:wchar_t /I"..\include" /I"..\dirent-1.13\include" /ZI /Gm /Od /fp:precise /D "HAVE_WINSOCK" /D "HAVE_WIN32_IPC" /D "HAVE_WIN32_PROC" /D "WIN32" /D "_DEBUG" /D "NO_AUTH" /D "_WINDLL" /D "_UNICODE" /D "UNICODE" /errorReport:prompt /WX- /Zc:forScope /RTC1 /Gd /Oy- /MTd /Fa"..\\win-out\\" /EHsc /nologo /Fo"..\\win-out\\" /Fp"..\win-out\libadb.pch" %files%
