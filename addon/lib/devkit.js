...
let devkit = module.exports = {
    ...
    createNewApp: function(manifestData) {
        ...
        if (ret == Ci.nsIFilePicker.returnOK || ret == Ci.nsIFilePicker.returnReplace) {
          ...
          projectPath = File.join(projectPath, slugify(manifestData.name));
