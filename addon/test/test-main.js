 ...
 * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
 ...
 /* Note: all tests that require main to be included should be put in this
  * file.  Re-requiring main in other tests causes the simulator to be
  * reinstantiated.  This causes unintending side effects when trying to shut
  * down ADB.  Investigation of unloading main needed. */
